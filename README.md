...
- Student interaction data containing:
  ...
  - Device type
  - Location
- Dataset type: Simulated / anonymized educational data  
- Format: CSV / Excel
...
- Which locations generate the highest number of sign-ups?
- How does search interest correlate with actual enrollments?
...
4. Designed interactive visuals for course-wise, device-wise, and location-based analysis
5. Built a conversion funnel to track user journey
6. Applied slicers and filters for dynamic insights
...
- Device-wise search distribution
- User conversion funnel
- Location-based signup analysis
...
- Metro cities generate the highest number of enrollments
- Strong correlation found between search interest and sign-ups for select courses
